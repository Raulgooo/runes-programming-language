...
| Inline/external modules and `use` | `project.c`, `resolver.c` | `core_codegen_modules.runes`, module fixtures | [Modules](reference/modules-ffi-tooling.md#modules-and-names) | Complete |
