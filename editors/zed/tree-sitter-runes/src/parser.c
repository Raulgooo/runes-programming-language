  ...
  switch (state) {
    case 0:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('h' <= lookahead && lookahead <= 'z')) ADVANCE(253);
      END_STATE();
    case 1:
    ...
    case 251:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(253);
      END_STATE();
    case 252:
      ACCEPT_TOKEN(sym_identifier);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(13)] = {
    ...
    [anon_sym_realm] = ACTIONS(116),
    [anon_sym_in] = ACTIONS(116),
    [anon_sym_except] = ACTIONS(116),
  ...
  [STATE(16)] = {
    ...
    [anon_sym_realm] = ACTIONS(128),
    [anon_sym_in] = ACTIONS(128),
    [anon_sym_except] = ACTIONS(128),
  ...
  [STATE(18)] = {
    ...
    [anon_sym_realm] = ACTIONS(136),
    [anon_sym_in] = ACTIONS(136),
    [anon_sym_except] = ACTIONS(136),
