...
PLATFORM_SRCS += src/platform/linux/x86_64/syscall.S
else
PLATFORM_SRCS += src/platform/unsupported/linux_syscall.c
endif
RUNTIME_SRCS = src/runtime.c src/utils/arena.c $(PLATFORM_SRCS)

CORE_SRCS = src/lexer.c src/parser.c src/ast.c src/monomorphize.c src/project.c src/target.c src/reachability.c src/utils/arena.c src/utils/strtab.c src/tools/ast_print.c src/symbol_table.c src/resolver.c src/types.c src/typecheck.c src/codegen.c
MAIN_SRC = src/main.c
TARGET = runes
...
test-unit: $(TARGET)
	...
	$(ARENA_TEST)
	$(CC) $(CFLAGS) src/tests/runtime_test.c $(RUNTIME_SRCS) -o $(RUNTIME_TEST)
	$(RUNTIME_TEST)
...
test-core: $(TARGET)
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_print.c $(RUNTIME_SRCS) -o /tmp/runes_core_print
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_forward.c $(RUNTIME_SRCS) -o /tmp/runes_core_forward
	/tmp/runes_core_forward
	./$(TARGET) src/tests/samples/core_codegen_control.runes --emit-c /tmp/runes_core_control.c
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_control.c $(RUNTIME_SRCS) -o /tmp/runes_core_control
	@test "$$(/tmp/runes_core_control)" = "23"
	./$(TARGET) src/tests/samples/core_codegen_struct.runes --emit-c /tmp/runes_core_struct.c
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_struct.c $(RUNTIME_SRCS) -o /tmp/runes_core_struct
	@test "$$(/tmp/runes_core_struct)" = "43"
	./$(TARGET) src/tests/samples/core_codegen_inference.runes --emit-c /tmp/runes_core_inference.c
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_inference.c $(RUNTIME_SRCS) -o /tmp/runes_core_inference
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_array_copy.c $(RUNTIME_SRCS) -o /tmp/runes_core_array_copy
	@test "$$(/tmp/runes_core_array_copy)" = "60"
	./$(TARGET) src/tests/samples/core_codegen_extern.runes --emit-c /tmp/runes_core_extern.c
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_extern.c $(RUNTIME_SRCS) -o /tmp/runes_core_extern
	@test "$$(/tmp/runes_core_extern)" = "42"
	./$(TARGET) src/tests/samples/core_codegen_globals.runes --emit-c /tmp/runes_core_globals.c
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_globals.c $(RUNTIME_SRCS) -o /tmp/runes_core_globals
	@test "$$(/tmp/runes_core_globals)" = "42"
	./$(TARGET) src/tests/samples/core_codegen_public_constants.runes --emit-c /tmp/runes_core_public_constants.c
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_public_constants.c $(RUNTIME_SRCS) -o /tmp/runes_core_public_constants
	@test "$$(/tmp/runes_core_public_constants)" = "42 42 255"
	./$(TARGET) --target x86_64-unknown-linux-gnu src/tests/samples/core_codegen_cfg.runes --emit-c /tmp/runes_core_cfg_linux.c
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_cfg_skips_module.c $(RUNTIME_SRCS) -o /tmp/runes_core_cfg_skips_module
	@test "$$(/tmp/runes_core_cfg_skips_module)" = "cfg skipped missing module"
	./$(TARGET) src/tests/samples/core_codegen_reachability.runes --emit-c /tmp/runes_core_reachability.c
	@! grep -q 'runes_test_unreachable_external' /tmp/runes_core_reachability.c
	@! grep -q 'also_unused' /tmp/runes_core_reachability.c
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_reachability.c src/runtime.c src/utils/arena.c -o /tmp/runes_core_reachability
	@test "$$(/tmp/runes_core_reachability)" = "42"
	./$(TARGET) src/tests/samples/core_codegen_const_pointer_ffi.runes --emit-c /tmp/runes_core_const_pointer_ffi.c
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_const_pointer_ffi.c src/tests/fixtures/const_pointer_ffi.c $(RUNTIME_SRCS) -o /tmp/runes_core_const_pointer_ffi
	@test "$$(/tmp/runes_core_const_pointer_ffi)" = "42 65"
	./$(TARGET) src/tests/samples/core_codegen_defer.runes --emit-c /tmp/runes_core_defer.c
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_defer.c $(RUNTIME_SRCS) -o /tmp/runes_core_defer
	@test "$$(/tmp/runes_core_defer)" = "$$(printf 'C\nB\nA\n7|C\nB\nA\n8|\nL\nE\nP\n-1')"
	./$(TARGET) src/tests/samples/core_codegen_variants.runes --emit-c /tmp/runes_core_variants.c
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_variants.c $(RUNTIME_SRCS) -o /tmp/runes_core_variants
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_errors.c $(RUNTIME_SRCS) -o /tmp/runes_core_errors
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_methods.c $(RUNTIME_SRCS) -o /tmp/runes_core_methods
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_std_option.c $(RUNTIME_SRCS) -o /tmp/runes_core_std_option
	...
	./$(TARGET) src/tests/samples/core_codegen_import_aliases.runes --emit-c /tmp/runes_core_import_aliases.c
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_import_aliases.c $(RUNTIME_SRCS) -o /tmp/runes_core_import_aliases
	@test "$$(/tmp/runes_core_import_aliases)" = "21 true 42 7 11 13 2 true 42 -1 17"
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_module_name_collision.c $(RUNTIME_SRCS) -o /tmp/runes_core_module_name_collision
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_modules_flat.c $(RUNTIME_SRCS) -o /tmp/runes_core_modules_flat
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_modules_directory.c $(RUNTIME_SRCS) -o /tmp/runes_core_modules_directory
	...
	./$(TARGET) --stdlib src/tests/module_fixtures/lazy_std src/tests/module_fixtures/lazy_std_main.runes --emit-c /tmp/runes_lazy_std.c
	@! grep -q 'broken' /tmp/runes_lazy_std.c
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_lazy_std.c $(RUNTIME_SRCS) -o /tmp/runes_lazy_std
	@test "$$(/tmp/runes_lazy_std)" = "42"
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_arrays_pointers.c $(RUNTIME_SRCS) -o /tmp/runes_core_arrays_pointers
	/tmp/runes_core_arrays_pointers
	./$(TARGET) src/tests/samples/core_codegen_systems.runes --emit-c /tmp/runes_core_systems.c
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_systems.c $(RUNTIME_SRCS) -o /tmp/runes_core_systems
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_systems_attributes.c $(RUNTIME_SRCS) -o /tmp/runes_core_systems_attributes
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_promote.c $(RUNTIME_SRCS) -o /tmp/runes_core_promote
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_deep_promotion.c $(RUNTIME_SRCS) -o /tmp/runes_core_deep_promotion
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_promote_aggregates.c $(RUNTIME_SRCS) -o /tmp/runes_core_promote_aggregates
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_promote_slices.c $(RUNTIME_SRCS) -o /tmp/runes_core_promote_slices
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_regional_arena.c $(RUNTIME_SRCS) -o /tmp/runes_core_regional_arena
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_if_values.c $(RUNTIME_SRCS) -o /tmp/runes_core_if_values
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_strings.c $(RUNTIME_SRCS) -o /tmp/runes_core_strings
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_c_string_cast.c $(RUNTIME_SRCS) -o /tmp/runes_core_c_string_cast
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_unicode_strings.c $(RUNTIME_SRCS) -o /tmp/runes_core_unicode_strings
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_string_ordering.c $(RUNTIME_SRCS) -o /tmp/runes_core_string_ordering
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_string_bounds.c $(RUNTIME_SRCS) -o /tmp/runes_core_string_bounds
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_string_boundary.c $(RUNTIME_SRCS) -o /tmp/runes_core_string_boundary
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_char_cast.c $(RUNTIME_SRCS) -o /tmp/runes_core_char_cast
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_char_cast_trap.c $(RUNTIME_SRCS) -o /tmp/runes_core_char_cast_trap
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_early_return.c $(RUNTIME_SRCS) -o /tmp/runes_core_early_return
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_function_values.c $(RUNTIME_SRCS) -o /tmp/runes_core_function_values
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_move_closure.c $(RUNTIME_SRCS) -o /tmp/runes_core_move_closure
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_promote_closure.c $(RUNTIME_SRCS) -o /tmp/runes_core_promote_closure
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_gc_move_closure.c $(RUNTIME_SRCS) -o /tmp/runes_core_gc_move_closure
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_gc_graph.c $(RUNTIME_SRCS) -o /tmp/runes_core_gc_graph
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_gc_typed_sequence.c $(RUNTIME_SRCS) -o /tmp/runes_core_gc_typed_sequence
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_promote_gc.c $(RUNTIME_SRCS) -o /tmp/runes_core_promote_gc
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_promote_gc_slice.c $(RUNTIME_SRCS) -o /tmp/runes_core_promote_gc_slice
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_gc_flex_global.c $(RUNTIME_SRCS) -o /tmp/runes_core_gc_flex_global
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_gc_temporaries.c $(RUNTIME_SRCS) -o /tmp/runes_core_gc_temporaries
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_gc_control_bindings.c $(RUNTIME_SRCS) -o /tmp/runes_core_gc_control_bindings
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_nullable.c $(RUNTIME_SRCS) -o /tmp/runes_core_nullable
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_nullable_unwrap.c $(RUNTIME_SRCS) -o /tmp/runes_core_nullable_unwrap
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_nested_pointer_types.c $(RUNTIME_SRCS) -o /tmp/runes_core_nested_pointer_types
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_null_unwrap.c $(RUNTIME_SRCS) -o /tmp/runes_core_null_unwrap
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_bounds.c $(RUNTIME_SRCS) -o /tmp/runes_core_bounds
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_overflow.c $(RUNTIME_SRCS) -o /tmp/runes_core_overflow
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_checked_shifts.c $(RUNTIME_SRCS) -o /tmp/runes_core_checked_shifts
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_narrow_integer_ops.c $(RUNTIME_SRCS) -o /tmp/runes_core_narrow_integer_ops
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_multiline_delimiters.c $(RUNTIME_SRCS) -o /tmp/runes_core_multiline_delimiters
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_slices.c $(RUNTIME_SRCS) -o /tmp/runes_core_slices
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_slice_aggregates.c $(RUNTIME_SRCS) -o /tmp/runes_core_slice_aggregates
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_slice_methods.c $(RUNTIME_SRCS) -o /tmp/runes_core_slice_methods
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -Werror /tmp/runes_core_std_bytes.c $(RUNTIME_SRCS) -o /tmp/runes_core_std_bytes
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_raw_slice.c $(RUNTIME_SRCS) -o /tmp/runes_core_raw_slice
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_zero_slice.c $(RUNTIME_SRCS) -o /tmp/runes_core_zero_slice
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_slice_bounds.c $(RUNTIME_SRCS) -o /tmp/runes_core_slice_bounds
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_slice_range.c $(RUNTIME_SRCS) -o /tmp/runes_core_slice_range
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_negation.c $(RUNTIME_SRCS) -o /tmp/runes_core_negation
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_shift_overflow.c $(RUNTIME_SRCS) -o /tmp/runes_core_shift_overflow
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_shift_count.c $(RUNTIME_SRCS) -o /tmp/runes_core_shift_count
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_core_array_return.c $(RUNTIME_SRCS) -o /tmp/runes_core_array_return
	@test "$$(/tmp/runes_core_array_return)" = "42"
	./$(TARGET) src/tests/samples/test_error_flow.runes --emit-c /tmp/runes_error_flow.c
	$(CC) -Isrc -std=c11 -Wall -Wextra /tmp/runes_error_flow.c $(RUNTIME_SRCS) -o /tmp/runes_error_flow
...
test-tooling: $(TARGET)
	@test "$$(./$(TARGET) --target-info)" = "x86_64-unknown-linux-gnu"
	@test "$$(./$(TARGET) --target x86_64-unknown-runes-none --target-info)" = "x86_64-unknown-runes-none"
	@if ./$(TARGET) --target invalid-target --target-info >/tmp/runes_invalid_target.out 2>&1; then \
		echo 'expected unsupported target to fail'; exit 1; \
	fi
	@grep -Fq 'Unsupported target triple: invalid-target' /tmp/runes_invalid_target.out
	...
	@cd src/tests/project_fixtures/workspace && ../../../../runec project | grep -Fq 'target: x86_64-unknown-linux-gnu'
	@cd src/tests/project_fixtures/workspace && ../../../../runec project --target x86_64-unknown-runes-none | grep -Fq 'target: x86_64-unknown-runes-none'
...
test-runtime-sanitize: $(TARGET)
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -g -fsanitize=address,undefined -fno-omit-frame-pointer /tmp/runes_asan_deep_promotion.c $(RUNTIME_SRCS) -o /tmp/runes_asan_deep_promotion
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -g -fsanitize=address,undefined -fno-omit-frame-pointer /tmp/runes_asan_promote_aggregates.c $(RUNTIME_SRCS) -o /tmp/runes_asan_promote_aggregates
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -g -fsanitize=address,undefined -fno-omit-frame-pointer /tmp/runes_asan_promote_slices.c $(RUNTIME_SRCS) -o /tmp/runes_asan_promote_slices
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -g -fsanitize=address,undefined -fno-omit-frame-pointer /tmp/runes_asan_promote_strings.c $(RUNTIME_SRCS) -o /tmp/runes_asan_promote_strings
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -g -fsanitize=address,undefined -fno-omit-frame-pointer /tmp/runes_asan_promote_closure.c $(RUNTIME_SRCS) -o /tmp/runes_asan_promote_closure
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -g -fsanitize=address,undefined -fno-omit-frame-pointer /tmp/runes_asan_gc_graph.c $(RUNTIME_SRCS) -o /tmp/runes_asan_gc_graph
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -g -fsanitize=address,undefined -fno-omit-frame-pointer /tmp/runes_asan_gc_typed_sequence.c $(RUNTIME_SRCS) -o /tmp/runes_asan_gc_typed_sequence
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -g -fsanitize=address,undefined -fno-omit-frame-pointer /tmp/runes_asan_gc_temporaries.c $(RUNTIME_SRCS) -o /tmp/runes_asan_gc_temporaries
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -g -fsanitize=address,undefined -fno-omit-frame-pointer /tmp/runes_asan_gc_control_bindings.c $(RUNTIME_SRCS) -o /tmp/runes_asan_gc_control_bindings
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -g -fsanitize=address,undefined -fno-omit-frame-pointer /tmp/runes_asan_promote_gc.c $(RUNTIME_SRCS) -o /tmp/runes_asan_promote_gc
	...
	$(CC) -Isrc -std=c11 -Wall -Wextra -g -fsanitize=address,undefined -fno-omit-frame-pointer /tmp/runes_asan_promote_gc_slice.c $(RUNTIME_SRCS) -o /tmp/runes_asan_promote_gc_slice
